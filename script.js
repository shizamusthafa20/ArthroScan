...
function updateUI(data) {
    ...
    const levelText = data.details.impact.infestation_level;
    infLevel.textContent = levelText;
    
    // Set color based on infestation level
    if (levelText.includes('High')) {
        infLevel.style.backgroundColor = 'var(--accent-red)';
    } else if (levelText.includes('Medium')) {
        infLevel.style.backgroundColor = 'var(--accent-orange)';
    } else {
        infLevel.style.backgroundColor = 'var(--accent-green)';
    }
